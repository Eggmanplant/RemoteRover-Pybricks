...
while True:
    ...
    device_motorB.run((0 - (speed * 10 * int(Button.LEFT_PLUS in buttons))) + (speed * 10 * int(Button.LEFT_MINUS in buttons)))
    device_motorA.run((0 - (speed * 10 * int(Button.RIGHT_MINUS in buttons))) + (speed * 10 * int(Button.RIGHT_PLUS in buttons)))
